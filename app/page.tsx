...
// import { CircularLogo } from "@/app/_components/Logo";
// import { useForm } from "./context/FormContext";
// import { steps } from "./constants/steps";
// import { StepContent } from "./_components/StepContent";

// export default function Home() {
//   const { stepState, setStepState } = useForm();

//   const [thumbnailStep, setThumbnailStep] = useState(false);

//   return (
//     <main className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-blue-100">
//       <div
//         className="relative bg-gradient-to-bl from-blue-200 to-blue-400 p-4 lg:rounded-r-3xl
//         rounded-b-xl
//       flex flex-col shadow-lg items-center justify-center"
//       >
//         <CircularLogo />
...
//         bg-gradient-to-br from-blue-200 to-blue-400 p-2 rounded-lg
//         "
//         >
...
//               onClick={() => setStepState(index)}
//             >
//               {index === stepState && (
//                 <Check
//                   className="h-6 w-6 text-white
//                 bg-black/80 rounded-full p-1"
//                 />
//               )}
//               <div className="ml-2">
//                 <h4
...
//         <div
//           className="
//           bg-gradient-to-br from-blue-200 to-blue-400 p-4 shadow-lg min-w-[300px] rounded-lg
//           max-w-[700px] w-full min-h-[300px] max-h-[800px]
//         "
//         >
//           <StepContent />
//         </div>

//         <div className="flex justify-between mt-4 w-full max-w-[700px]">
//           <button
...
//             className="bg-blue-500 text-white mt-4 p-2 rounded-lg"
//             onClick={() => setStepState(stepState + 1)}
//             disabled={stepState === steps.length - 1}
//           >
//             Next
//           </button>
//         </div>
